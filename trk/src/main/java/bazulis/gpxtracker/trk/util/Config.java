...
public class Config {
    ...
    public static final String TRACK_SERVICE_RECEIVER = "bazulis.gpxtracker.trk.PUSHCOMMANDS";
    public static final String HRM_SERVICE_RECEIVER = "bazulis.gpxtracker.trk.HRMRECEIVER";
